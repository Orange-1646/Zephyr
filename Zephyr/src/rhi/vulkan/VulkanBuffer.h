...
namespace Zephyr
{
    ...
    public:
        ...
        inline uint32_t GetOffset(uint32_t index) { return m_RingBufferAlignment * index; }
    private:
        uint32_t GetBufferSize(VulkanDriver* driver, uint32_t size, BufferMemoryType type);
    private:
